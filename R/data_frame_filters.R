...
# coluna do 1 com coluna do 2
df_merged <- merge(stats,mydf,by.x = "Country.Code", by.y = "Code")
head(df_merged)

# tirar quem nao quero
df_merged$Country <- NULL
str(df_merged)


qplot(data=df_merged, 
      x=Internet.users,
      y=Birth.rate,
      colour=Region,
      size=I(2),
      shape=I(19), # R shapes in google
